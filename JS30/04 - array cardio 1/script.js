...
//arrow function
// console.log(fifteen); // prints out all inventors born in 1500s
console.table(fifteen); // prints out all inventors born in 1500s
...
// 2 items, sort these 2 items, returning 1 or -1 which bubles these items up and down in the array
// 3. Sort the inventors by birthdate, oldest to youngest

// const ordered = inventors.sort(function(a, b) {
// 1st person is a 2nd person is b these 2 are compared
//   if (a.year > b.year) {
//     return 1;
//   } else {
//     return -1;
...
// ternary operator  inventor a > inventor b ? is this true? if true return 1 if not return -1
console.table(ordered);

// Array.prototype.reduce()
// allow to build something on every single one
